                ...
                <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
                    <div className="max-w-2xl">
                        ...
                        <p className="mt-4 text-slate-400">
                            Manage your tuition requests, review application
                            status, and discover the best tutors in one
            ...
            <div className="grid gap-4 md:grid-cols-3">
                <article className="rounded-3xl border border-slate-800 bg-slate-900/70 p-6 shadow-xl shadow-slate-950/20">
                    ...
                    <p className="mt-4 text-sm text-slate-400">
                        Track your current tuition posts and review tutor
                        responses.
                    </p>
                </article>
                ...
                <article className="rounded-3xl border border-slate-800 bg-slate-900/70 p-6 shadow-xl shadow-slate-950/20">
                    ...
                    <p className="mt-4 text-sm text-slate-400">
                        See how many tutors have shown interest in your tuition
                        requests.
                    </p>
                </article>
                ...
                <article className="rounded-3xl border border-slate-800 bg-slate-900/70 p-6 shadow-xl shadow-slate-950/20">
                    ...
                    <p className="mt-4 text-sm text-slate-400">
                        Monitor your progress and stay on top of active tuition
                        sessions.
                    </p>
                </article>
            </div>
                ...
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        ...
                        <p className="mt-2 text-slate-400">
                            Use the dashboard shortcuts to manage your tuitions
                            faster.
                        </p>
                    </div>
                    <Link
                ...
                <div className="mt-6 grid gap-4 md:grid-cols-3">
                    ...
                    >
                        ...
                        <p className="mt-3 text-sm text-slate-400">
                            Edit, review status, or delete your existing tuition
                            posts.
                        </p>
                    </Link>
                    ...
                    >
                        ...
                        <p className="mt-3 text-sm text-slate-400">
                            Review tutors and tuition posts you saved for later.
                        </p>
                    </Link>
                    ...
                    >
                        ...
                        <p className="mt-3 text-sm text-slate-400">
                            Manage invoices, completed payments, and upcoming
                            tuition fees.
                        </p>
                    </Link>
                </div>
